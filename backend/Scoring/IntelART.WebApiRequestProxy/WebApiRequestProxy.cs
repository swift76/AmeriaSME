    ...
    public class WebApiRequestProxy
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            if (handlerRule != null)
            {
                ...
                if (requestMessage.Content != null)
                    requestMessage.Content.Headers.Add("X-SME-IP", httpContext.Connection.RemoteIpAddress.ToString());
            ...
            else
            {
                ...
                if (httpContext.Request != null)
                    httpContext.Request.Headers.Add("X-SME-IP", httpContext.Connection.RemoteIpAddress.ToString());
