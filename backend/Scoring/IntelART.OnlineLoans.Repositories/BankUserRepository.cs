...
namespace IntelART.OnlineLoans.Repositories
{
    public class BankUserRepository : BaseRepository
    {
        ...
        public void CreateBankUser(BankUser bankUser, int applicationUserId)
        {
            ...
            changes.Add("Անուն", bankUser.FIRST_NAME_AM.Trim());
            changes.Add("Ազգանուն", bankUser.LAST_NAME_AM.Trim());
            ...
            parameters.Add("FIRST_NAME", bankUser.FIRST_NAME_AM.Trim());
            parameters.Add("LAST_NAME", bankUser.LAST_NAME_AM.Trim());
        ...
        public void ModifyBankUser(BankUser bankUser, int applicationUserId)
        {
            ...
            if (!string.IsNullOrEmpty(bankUser.FIRST_NAME_AM))
            {
                parameters.Add("FIRST_NAME", bankUser.FIRST_NAME_AM.Trim());
                changes.Add("Անուն", bankUser.FIRST_NAME_AM.Trim());
            }
            if (!string.IsNullOrEmpty(bankUser.LAST_NAME_AM))
            {
                parameters.Add("LAST_NAME", bankUser.LAST_NAME_AM.Trim());
                changes.Add("Ազգանուն", bankUser.LAST_NAME_AM.Trim());
            }
