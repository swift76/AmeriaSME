...
$(document).ready(function () {
  $("#registerTIN, #registerPhone, #userName").keydown(numInputKeydown);
  $("#registerTIN, #registerPhone, #userName").bind(
    "keyup change",
    numInputChange
  );
  $("#registerTIN, #registerPhone, #userName").bind("paste", numInputPaste);
