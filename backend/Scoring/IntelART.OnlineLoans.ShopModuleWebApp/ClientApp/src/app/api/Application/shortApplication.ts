...
import { applicationAction as actions } from '@store/reducers/root-actions'
import { applicationActions } from '@store/reducers/root-actions'
import axios from 'app/api'
import { toast } from 'react-toastify'

export const getApplication = (id: string) => async (
