...
import { IPostMainApplicationData } from '@store/reducers/mainApplication/models'
import { Utils } from 'app/services/utils'
import { mainApplicationAction as actions } from '@store/reducers/root-actions'
...
export const saveMainApplication = (
  id: string,
  data: IPostMainApplicationData
