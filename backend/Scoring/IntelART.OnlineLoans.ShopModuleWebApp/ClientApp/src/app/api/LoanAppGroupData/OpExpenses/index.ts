...
export const getOpExpanses = (id: string) => async (dispatch: Dispatch<AnyAction>) => {
    dispatch(opExpenses.getOpExpensesRequest());
    try {
        const response = await axios.get(`/ApplicationGroupData/CompanyOperationalExpenses/${id}`);
