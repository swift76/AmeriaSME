...
import { loanSettingsAction as actions } from 'app/store/reducers/root-actions';
...
export const getUnsecuredLimits = () => async (dispatch: Dispatch<AnyAction>) => {
    try {
...
export const getLoanSpecialistLoanTerms = () => async (dispatch: Dispatch<AnyAction>) => {
    try {
