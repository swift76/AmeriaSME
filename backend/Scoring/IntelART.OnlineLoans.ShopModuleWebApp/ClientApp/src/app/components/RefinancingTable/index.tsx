...
const RefinancingTable: React.FC<IRefinancingProps> = props => {
    ...
    return (
        <>
            ...
            {caption && (
                <p>
                    Խնդրում ենք մուտքագրել նշված վարկերի վարկային կոդերը, որոնք կարող եք տեսնել Ձեր
                    վարկային պայմանագրերի աջ անկյունում: Վարկային կոդի բացակայության դեպքում խնդրում
                    ենք անձը հաստատող փաստաթղթով մոտենալ «Ամերիաբանկ» ՓԲԸ-ի ցանկացած մասնաճյուղ կամ
                    կապ հաստատել «Ամերիաբանկ» ՓԲԸ-ի հետ (+37410) 56 11 11 հեռախոսահամարով։
                    «Ամերիաբանկ» ՓԲԸ-ի սպասարկման ցանցը և աշխատանքի ժամանակացույցը ներկայացված են{' '}
                    <a href="http://ameriabank.am/Infrastructure.aspx?&lang=33" target="_blank">
                        այստեղ։
                    </a>
                </p>
            )}
                                    ...
                                    render={arrayHelpers =>
                                        ...
                                        values.loans.map((loan, index) => (
                                            <tr key={`${loan.ROW_ID}_${loan.APPLICATION_ID}`}>
                                                ...
                                                <td>
                                                    <Form.Group
                                                        controlId={`loans.${index}.LOAN_CODE`}
                                                    >
                                                        <Form.Control
                                                            type="text"
