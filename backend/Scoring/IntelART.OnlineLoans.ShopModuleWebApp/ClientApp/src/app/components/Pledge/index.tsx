...
const Pledge: React.FC<
  IPledgeProps & FormikProps<ILoanSpecApplicationData>
> = props => {
  const { id, values, handleChange, errors, touched, setFieldValue } = props
  const [pledgePercent, setPledgePercent] = useState(0)
  const dispatch = useDispatch()

  const pledgers = useSelector(
    ({ loanAppGroupData }: ReducerState) => loanAppGroupData.pledgers
  )
  const pledgeTypes = useSelector(
    ({ directory }: ReducerState) => directory.pledgeTypes
  )
    ...
    <div className={`adv-loan-section`} id="applicationPledgers">
      ...
      <Table striped={true} borderless={true} className="adv-loan-table">
          ...
          <tr>
            ...
            <td colSpan={2}>
              <Form.Check
                ...
                onChange={() =>
                  setFieldValue('SHOULD_MAIN_AGREEMENT_SIGNED', true)
                }
                isInvalid={
          ...
          <tr>
            ...
            <td colSpan={2}>
              ...
              <Form.Check
                ...
                type="radio"
                onChange={() =>
                  setFieldValue('IS_MAIN_AGREEMENT_SIGNED', false)
                }
                isInvalid={
                  touched.IS_MAIN_AGREEMENT_SIGNED &&
                  !!errors.IS_MAIN_AGREEMENT_SIGNED
        ...
        <tbody>
          <tr>
            <td>
              <Form.Label htmlFor="MARKET_PRICE">
                Գրավի շուկայական արժեք
              </Form.Label>
            </td>
            <td colSpan={2}>
          ...
          <tr>
            <td>
              <Form.Label htmlFor="LIQUID_PRICE">
                Գրավի լիկվիդային արժեք
              </Form.Label>
            </td>
            <td colSpan={2}>
          ...
          <tr>
            <td>
              <Form.Label htmlFor="APPRAISAL_DATE">
                Գնահատման ամսաթիվ
              </Form.Label>
            </td>
            <td colSpan={2}>
              <Form.Group controlId="APPRAISAL_DATE" as={Row}>
                <DatePicker
                  ...
                  customInput={
                    <Form.Control
                      isValid={touched.APPRAISAL_DATE && !errors.APPRAISAL_DATE}
                      isInvalid={
                    ...
                    <Form.Group controlId="ESTATE_ADDRESS" as={Row}>
                      <Col sm={8}>
                        <Form.Control
                          ...
                          isValid={
                            touched.ESTATE_ADDRESS && !errors.ESTATE_ADDRESS
                          }
                          isInvalid={
                            touched.ESTATE_ADDRESS && !!errors.ESTATE_ADDRESS
                          }
                ...
                <tr>
                  ...
                  <td colSpan={2}>
                    <Form.Row>
                      ...
                      <Form.Group as={Col} sm={3} controlId={name}>
                        <Form.Control
                          ...
                          isValid={
                            touched.ESTATE_LAND_AREA && !errors.ESTATE_LAND_AREA
                          }
                          isInvalid={
                        ...
                        <DatePicker
                          ...
                          selected={
                            values.OWNERSHIP_CERTIFICATE_DATE
                              ? new Date(values.OWNERSHIP_CERTIFICATE_DATE)
                              : null
                          }
                          onChange={(date, e) => {
                            if (date) {
                  ...
                  <td colSpan={2}>
                    <Form.Group controlId="VEHICLE_MODEL" as={Row}>
                      <Form.Control
                        ...
                        onChange={handleChange}
                        isValid={touched.VEHICLE_MODEL && !errors.VEHICLE_MODEL}
                        isInvalid={
                  ...
                  <td colSpan={2}>
                    <Form.Group controlId="VEHICLE_VIN" as={Row}>
                      <Form.Control
                        ...
                        isInvalid={touched.VEHICLE_VIN && !!errors.VEHICLE_VIN}
                      />
                      <Form.Control.Feedback type="invalid">
                        {errors.VEHICLE_VIN}
                      </Form.Control.Feedback>
                    ...
                    <Form.Row>
                      ...
                      >
                        <Form.Control
                          name="OWNERSHIP_CERTIFICATE_NUMBER"
                          type="number"
                          value={String(values.OWNERSHIP_CERTIFICATE_NUMBER)}
                          onChange={handleChange}
                          placeholder="Համար"
                          isValid={
                            touched.OWNERSHIP_CERTIFICATE_NUMBER &&
                  ...
                  <td colSpan={2}>
                    <Form.Group controlId="VEHICLE_DATE" as={Row}>
                      <DatePicker
                        ...
                        onChange={(date, e) => {
                          date &&
                            setFieldValue('VEHICLE_DATE', moment(date).format())
                        }}
                        inline={false}
                        name="VEHICLE_DATE"
                        customInput={
