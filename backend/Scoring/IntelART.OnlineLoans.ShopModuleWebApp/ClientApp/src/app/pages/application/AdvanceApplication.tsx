...
import CancelModalContent from '@components/Modals/CancelModalContent'
...
const Page: React.FC<IAdvanceAppProps> = props => {
  ...
  const onValidSubmit = async (values: ILoanSpecApplicationData) => {
    ...
    if (
      Utils.checkPhotosIsUploaded(pledgeIsShow, pledgeCount, nonPledgeCount)
    ) {
      try {
                      ...
                      <Row>
                        ...
                        >
                          <p className="mt-3 mb-4">
                            ...
                            />
                            Բոլոր տվյալները անհրաժեշտ է լրացնել միջին ամսական
                            կտրվածքով:
                          </p>
                          ...
                          <AppCompanyData
                            ...
                            sync={['GOOD_MONTH_EARNINGS', 'BAD_MONTH_EARNINGS']}
                            {...formikProps}
                          />
                            ...
                            {[
                              {
                                ...
                                noteFieldName: 'AREA_RENTED_COMMENT',
                                radio: true,
                              },
                            ]}
                          </AppCompanyData>
                          ...
                          >
                            <h5 className="adv-loan-title">Երաշխավորություն</h5>
                            <Table
                              striped={true}
                              borderless={true}
                          ...
                          <div id="companyPhotos" className="adv-loan-section">
                          ...
                          {pledgeIsShow && <Pledge {...formikProps} id={id} />}
                          ...
                          <div className={`adv-loan-section`}>
                            ...
                            >
                              <Form.Control
                                ...
                                rows={3}
                                value={
                                  formikProps.values.ACTIVITY_DESCRIPTION || ''
                                }
                                onChange={formikProps.handleChange}
                                isValid={
                                  formikProps.touched.ACTIVITY_DESCRIPTION &&
                                  !formikProps.errors.ACTIVITY_DESCRIPTION
                                }
                                isInvalid={
                                  formikProps.touched.ACTIVITY_DESCRIPTION &&
                                  !!formikProps.errors.ACTIVITY_DESCRIPTION
