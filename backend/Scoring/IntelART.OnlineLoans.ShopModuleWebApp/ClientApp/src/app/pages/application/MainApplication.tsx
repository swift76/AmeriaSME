...
import MainApplicationContainer, {
  IMainAppProps,
} from '@pageContainers/MainApplicationContainer'
...
const Page: React.FC<IMainAppProps> = React.memo(props => {
  ...
  const handleChangeAmount = (refinancing: boolean) => (
                      ...
                      {!!scoringResult.APPROVED_AMOUNT_1 && (
                        <Form.Group controlId="APPROVED_AMOUNT_1" as={Row}>
                          ...
                          <Form.Check
                            ...
                            isInvalid={
                              touched.FINAL_AMOUNT && !!errors.FINAL_AMOUNT
                            }
                          />
                        </Form.Group>
                      )}
                      ...
                      <Form.Group controlId="REPAYMENT_DAY" as={Row}>
                        ...
                        <Col sm={7}>
                          <Form.Control
                            ...
                            isValid={
                              touched.REPAYMENT_DAY && !errors.REPAYMENT_DAY
                            }
                            isInvalid={
                              touched.REPAYMENT_DAY && !!errors.REPAYMENT_DAY
                            }
