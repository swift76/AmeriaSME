...
const LoanSpecBase: React.FC<ILoanSpecBaseProps> = props => {
    ...
    useEffect(() => {
        !businessStateTypes.businessStateTypesLoaded && dispatch(getBusinessStateTypes(id));
            ...
            <Col className="mr-3">
                <fieldset className="loan-form-group">
                    <Form.Group controlId="TAX_ID_NUMBER" as={Row} className="p-0">
                        <Form.Label column={true} sm={5} className="equal-to-company-height">
                            ՀՎՀՀ
                        </Form.Label>
                        <Col sm={7}>
                            <Form.Control
                        ...
                        <Col sm={7}>
                            <NumberFormat
                                ...
                                isAllowed={val => {
                                    ...
                                    return (
                                        newVal - Number(values.LS_LOAN_AMOUNT) <= 0 ||
                                        newVal <= loanLimits.TO_AMOUNT
                                    );
                                }}
                                className={clsx({
                                    'is-valid': touched.LS_LOAN_AMOUNT && !errors.LS_LOAN_AMOUNT,
                                    'is-invalid': touched.LS_LOAN_AMOUNT && !!errors.LS_LOAN_AMOUNT
                                })}
                                placeholder={`${Utils.formatAsCurrency(
                    ...
                    <Form.Group controlId="LS_REPAYMENT_DAY" as={Row}>
                        ...
                        <Col sm={7}>
                            <Form.Control
                                ...
                                isInvalid={touched.LS_REPAYMENT_DAY && !!errors.LS_REPAYMENT_DAY}
                            />
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group controlId="FAMILY_MEMBER_COUNT" as={Row}>
                        ...
                        <Col sm={4}>
                            <Form.Control
                                ...
                                onChange={handleChange}
                                isValid={touched.FAMILY_MEMBER_COUNT && !errors.FAMILY_MEMBER_COUNT}
                                isInvalid={
                    ...
                    <Form.Group controlId="BUSINESS_STATE_CODE" as={Row}>
                        ...
                        <Col sm={7}>
                            <Form.Control
                                ...
                                onChange={handleChange}
                                isValid={touched.BUSINESS_STATE_CODE && !errors.BUSINESS_STATE_CODE}
                                isInvalid={
