...
} from '@store/reducers/mainApplication/models'
...
export default (Page: React.FC<IMainAppProps>) => {
  ...
  return withRouter(
    connect(mapStateToProps, mapDispatchToProps)(MainApplicationContainer)
  )
}
...
const mapDispatchToProps = (dispatch: AppTypes.DispatchActions) => {
  return {
    ...
    getLoanParameters: (loanTypeCode: string) =>
      dispatch(getLoanParameters(loanTypeCode)),
