...
class Authorization extends React.Component<IProps, IState> {
    ...
    static getDerivedStateFromProps(props: IProps, state: IState) {
        ...
        const hasRouteAccess =
            matched && matched.route.auth
                ? userLoggedIn
                : userLoggedIn && !matched.route.auth
                ? false
                : true;
    ...
    render() {
        return this.state.hasRouteAccess ? (
...
export default withRouter(connect(mapStateToProps)(Authorization as any));
