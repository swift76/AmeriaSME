create or alter procedure sp_GetLegalApplicationBeforeACRA(@ID	uniqueidentifier)
AS
	select isnull(a.ISN,-1) as ISN
		...
		,a.NORQ_LEGAL_TRY_COUNT,a.ACRA_LEGAL_TRY_COUNT,a.EREGISTER_TRY_COUNT,a.NORQ_TRY_COUNT
